      ...
      <div className="grid gap-16 md:gap-8 md:grid-cols-2">
        ...
        >
          <h3 className="text-2xl font-bold">
            As a back-end developer, I specialize in building and maintaining
            the functionality of web applications.
          </h3>
          <p className="font-medium">
            Hi, my name is Pius Njeri and I am a web developer with over 2 years
            of experience in the field. I specialize in both back and front-end development as well as cloud implementation.
            I have a strong background in HTML & CSS, JavaScript and Vb.net. I am also well versed with popular frameworks such as ReactJS and can build apps on Next.Js. I am always looking to
