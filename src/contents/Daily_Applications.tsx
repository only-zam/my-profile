export const DAILY_APPLICATIONS = [
  ...
  },
  {
    app: 3,
    name: "AWS Console",
    img: "https://upload.wikimedia.org/wikipedia/commons/5/5c/AWS_Simple_Icons_AWS_Cloud.svg",
    useCase: ["Deploying apps", "Cloud ops"],
  },
  {
    app: 4,
    name: "IntelliJ IDE",
    img: "https://upload.wikimedia.org/wikipedia/commons/9/9c/IntelliJ_IDEA_Icon.svg",
    useCase: ["Writing Code"],
  },
  {
    app: 5,
    name: "Twitter",
